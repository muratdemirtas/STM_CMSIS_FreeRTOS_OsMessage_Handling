...
$(BINARYDIR)/stm32f4xx_hal_timebase_TIM.o : Src/stm32f4xx_hal_timebase_TIM.c $(all_make_files) |$(BINARYDIR)
	$(CC) $(CFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)
